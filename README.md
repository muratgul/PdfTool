...
- **Add Page Numbers:** Add stylish and automatic page numbers to the left or right corners in any font size.
...
- **Watermark:** Brand your documents by adding a transparent watermark in text or image format to the center of the pages.
